...
Unlike [Lido's stETH](https://github.com/lidofinance/lido-dao/tree/master/contracts/0.4.24), the Stake token does not rebase; instead, the exchange rate between Luna and Stake increases (i.e. each Stake becomes worth more Luna) as staking rewards are harvested, and reduces if validators are slashed.
